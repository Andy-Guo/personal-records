...
ofports_ip=("192.168.10.22" "192.168.10.21" "192.168.10.23")
ofports_mac=("6a:c3:9a:ca:6c:32" "8a:d0:4c:03:95:60" "42:0f:16:6b:ef:d5")
...
remote_tunnel_ip="192.168.119.131"
tunnel_ofports=(4)
...
remote_ofports_mac=("26:6b:0b:9a:2c:f1" "26:4a:e2:c2:39:58" "d6:96:bc:42:04:ae") #对应于ofport 的mac地址数组
remote_ofports_ip=("192.168.10.12" "192.168.10.11" "192.168.10.13")  #对应于ofport的ip地址数组
